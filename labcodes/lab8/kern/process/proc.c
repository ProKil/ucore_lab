...
alloc_proc(void) {
     ...
     */
        ...
        proc->parent = NULL;
        proc->mm = NULL;
        memset(&(proc->context), 0, sizeof(struct context));    // answer
        proc->tf = NULL;
        proc->cr3 = boot_cr3;
        proc->flags = 0;
        memset(proc->name, 0, PROC_NAME_LEN);                   // answer
     //LAB5 2014011357 : (update LAB4 steps)
    /*
     ...
     */
     ...
     //LAB6 2014011357 : (update LAB5 steps)
    /*
    ...
    //LAB8:EXERCISE2 2014011357 HINT:need add some code to init fs in proc_struct, ...
        proc->filesp = NULL;
    }
    return proc;
}
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2014011357  HINT:how to load the file with handler fd in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
